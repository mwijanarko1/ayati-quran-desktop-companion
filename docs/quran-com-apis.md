...
- [Follow all featured users](https://api-docs.quran.foundation/docs/user_related_apis_versioned/users-controller-follow-featured-users)
- [Get featured users for follow recommendation](https://api-docs.quran.foundation/docs/user_related_apis_versioned/users-controller-get-featured-users)
...
- [Follow all featured users](https://api-docs.quran.foundation/docs/user_related_apis_prelive/users-controller-follow-featured-users)
- [Get featured users for follow recommendation](https://api-docs.quran.foundation/docs/user_related_apis_prelive/users-controller-get-featured-users)
